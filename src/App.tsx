...
const SinglePageApp = () => {
  ...
  return (
    <div className="min-h-screen bg-white" dir={dir}>
      ...
      {/* Home Section */}
      <section id="home" className={activeSection === 'home' ? 'block' : 'block'}>
        <HeroSection />
      </section>
      
      {/* Products Section */}
      <section id="products" className={activeSection === 'products' ? 'block' : 'block'}>
        <FeaturedProducts />
      </section>
      
      {/* Reviews Section */}
      <section id="reviews" className={activeSection === 'reviews' ? 'block' : 'block'}>
      ...
      {/* FAQ Section */}
      <section id="faq" className={activeSection === 'faq' ? 'block' : 'block'}>
