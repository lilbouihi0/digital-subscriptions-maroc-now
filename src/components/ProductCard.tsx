...
const ProductCard = ({ 
  ...
  return (
    <Card className="overflow-hidden card-hover border-0 shadow-card">
      ...
      <CardContent className="p-6">
        <div className="mb-4">
          ...
          <p className="text-gray-600 text-sm">{duration} Subscription</p>
        </div>
      ...
      <CardFooter className="px-6 pb-6 pt-0">
        ...
        >
          <a 
            href={`https://wa.me/+212000000000?text=I'm%20interested%20in%20the%20${name}%20subscription`}
            target="_blank" 
